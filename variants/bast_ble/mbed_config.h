...
#define MBED_CONF_NORDIC_NRF_LF_CLOCK_CALIB_MODE_CONFIG                       2                                                                                                // set by target:MCU_NRF52840
#define MBED_CONF_NORDIC_NRF_LF_CLOCK_CALIB_TIMER_INTERVAL                    16                                                                                               // set by target:MCU_NRF52840
#define MBED_CONF_NORDIC_NRF_LF_CLOCK_SRC                                     NRF_LF_SRC_RC                                                                                  // set by target:MCU_NRF52840
